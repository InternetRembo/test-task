...
const PaymentBlock = () => {
  ...
  const onSubmit = values => alert('Ми відправили дані!')
        ...
        <Form onSubmit={formik.handleSubmit} >
          <Form.Group controlId="formBasicCardholderName">
            ...
            {formik.errors.cardholderName && formik.touched.cardholderName ?
                <ErrorBlock error={formik.errors.cardholderName} target={refs.cardholderRef}/> : null}
          ...
          <Form.Group controlId="formBasicCardNumber">
            ...
            {formik.errors.cardNumber && formik.touched.cardNumber ?
                <ErrorBlock error={formik.errors.cardNumber} target={refs.cardNumberRef}/> : null}

            <Form.Control ref={refs.cardNumberRef}
                          id='cardNumber'
                          name='cardNumber'
                          className="mb-3"
                          type="text"
          ...
          <Flex style={{ width: '240px' }} justify="space-between">
            <Form.Group controlId="formBasicExpireDate">
              ...
              {formik.errors.expireDate && formik.touched.expireDate ?
                  <ErrorBlock error={formik.errors.expireDate} target={refs.expireDateRef}/> : null}
            ...
            <Form.Group controlId="formBasicSecurityCode">
              ...
              {formik.errors.securityCode && formik.touched.securityCode ?
                  <ErrorBlock error={formik.errors.securityCode} target={refs.securityCodeRef}/> : null}
